...
var openam_url        = "http://openam135.sample.com:8080/openam";
var current_realm     = "/employees";
var access_token_url  = openam_url + "/oauth2/employees/access_token";
var authenticate_url  = openam_url + "/json/employees/authenticate";
var policy_create_url = openam_url + "/json/employees/users/alice/uma/policies?_action=create";
var rpt_url           = openam_url + "/uma/employees/authz_request";

// OpenIG configuration
var openig_url        = "http://docapp45-ig.sample.com:9000";
var share_url         = openig_url + "/openig/api/system/objects/router-handler/routes/01-uma/objects/umaserviceext/share?_action=create";

// UMA RS configuration with OpenAM
var rs_client_id      = "OpenIG_RS";
...
var resource_url = "http://docapp45-ig.sample.com:9000/login";
